    ...
    <footer className="bg-background text-secondaryText pt-12 pb-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
          {/* Languages Column */}
          <div>
            <h3 className="text-secondaryText font-semibold text-lg mb-4">Courses</h3>
            <ul className="space-y-2">
              {['English', 'German (A1-C1)', 'Chinese (HSK)', 'French (A1-B2)', 
                 'IELTS Preparation', 'Spoken English', 'Goethe Exam Prep', 
                 'HSK Test Prep', 'DELF Prep'].map((language) => (
                <li key={language}>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['Our Methodology', 'Success Stories', 'University Partners', 
                 'Corporate Programs', 'Refer a Friend', 'Student Discount', 
                 'Educators Discount', 'Scholarships'].map((item) => (
                <li key={item}>
                  <Link href="#" className="hover:text-white transition">
                    {item}
                  </Link>
          ...
          <div>
            ...
            <ul className="space-y-2">
              {['About Us', 'Our Faculty', 'The Hallmark Method', 'Pricing', 
                 'Press', 'Careers', 'Contact Us', 'FAQ', 'Accessibility'].map((item) => (
                <li key={item}>
                  <Link href="#" className="hover:text-white transition">
                    {item}
                  </Link>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/share/1Q9wWtHaRF/" target="_blank" className="hover:text-white">
